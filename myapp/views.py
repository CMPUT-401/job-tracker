        ...
        if action == "add_to_blank":
            ...
            if new_section:
                ...
                if new_section and new_section not in master_resume:
                    master_resume[new_section] = []  # Initialize the new section with an empty list of items
            ...
            if section and new_item:
                ...
                if section not in blank_resume:
                    blank_resume[section] = []  # Create section in blank resume if it doesn't exist
